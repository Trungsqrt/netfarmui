...
function Slide() {
   return (
      ...
      <div className={styles.content}>
        ...
        <div className={styles.description}>
          <h4 style={{fontSize: 30 + 'px', color: 'white', paddingBottom: 50 + 'px'}}>Sản xuất vụ mùa đảm bảo trong khung thời vụ tốt nhất</h4>
          <p style={{fontSize: 20 + 'px', color: 'white', paddingBottom: 20 + 'px'}}>Đến thời điểm này, gần 80% diện tích lúa mùa của tỉnh đã được gieo cấy xong, đảm bảo khung thời vụ tốt nhất tạo điều kiện để cấy lúa sinh trưởng, phát triển thuận lợi.</p>
