...
function MyComponent() {
    ...
    return (
        <div>
            ...
            <Row className="justify-content-md-center">
                <Form.Group style={{ width: '18rem' }} controlId="formFile" className="d-flex justify-content-center">
  ...
  <Col md="12" lg="4" className="mb-4 mb-lg-0">
    <Card.Img src={data.similar_images[0].url} fluid className="w-100" />
  </Col>
) : (
    <Col md="12" lg="4" className="mb-4 mb-lg-0">
    <Card.Img src={noImage} fluid className="w-100" />
                                        ...
                                        <Col md="8" className="text-center">
                                            ...
                                            {data.plant_details.wiki_description && data.plant_details.wiki_description.value && (
